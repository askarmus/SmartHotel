...
public class ExceptionLoggingMiddleware
{
    ...
    private static ErrorResponse FormatErrorMessage(Exception ex) =>
        ex switch
        {
           ...
           // ValidationException validationException => new ErrorResponse( validationException.ExceptionCode, validationException.Message,validationException.ValidationMessages),
            ValidationException validationException => new ErrorResponse(validationException.Errors, validationException.Message, -1),
            AppException appException => new ErrorResponse(appException.ExceptionCode, appException.Message),
